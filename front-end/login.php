    ...
    <div class="row">
        ...
        <div class="col-md-6 p-3">
            ...
            <div class="row g-0">
                ...
                <div class="col-lg-5 shadow rounded p-5 bg-light">
                    <h3 class="h3 mb-3">Not a registered user?</h3>
                    <a href="register.php<?php echo $queryString; ?>" class="btn btn-lg btn-warning">Create an account</a>
                </div>
            </div>
        </div>
        <div class="col-md-3"></div>
